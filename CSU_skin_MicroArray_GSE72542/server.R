...
#       choices <- "Tissue"
#       selectInput("facet", "Additional Grouping Variable", choices = choices, selected = "Tissue")
#     }
#   })
  ...
  distribution.plot <- reactive({
    ...
    distribution.plot_filtered <- ggplot(plot.df, aes(x = Tissue, y = value, fill = Stim)) +
